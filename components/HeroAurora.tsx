...
export default function HeroAurora({
  badge = "Trusted Community Healthcare",
  headline = "Whole-person care that feels calm, clear, and connected",
  subheadline = "Harborview Health delivers compassionate primary and specialty care with easy scheduling, telehealth, and a dedicated care team.",
  primaryCta = { label: "Schedule a Visit", href: "/appointments" },
  secondaryCta = { label: "Meet the Doctors", href: "#doctors" },
}: Partial<HeroAuroraProps>) {
  return (
    <AuroraBackground auroraColors={["#10b981", "#059669", "#34d399", "#a7f3d0", "#6ee7b7"]}>
      <motion.div
